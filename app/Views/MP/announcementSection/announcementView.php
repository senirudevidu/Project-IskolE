                ...
                <?php foreach ($announcements as $announcement): ?>
                    <div class="border-container info-box">
                        ...
                        <div class="right two-com">
                            <form action="/app/Controllers/updateAnnouncementController.php" method="GET"
                                style="display:inline;">
                                <input type="hidden" name="id" value="<?= $announcement['announcement_id'] ?>">
                                <button class="btn" type="button"
                                    onclick='openPopup(<?= json_encode($announcement) ?>)'>Edit</button>
                            </form>

                            <form action="/app/Controllers/deleteAnnouncementController.php" method="POST"
                                style="display:inline;"
