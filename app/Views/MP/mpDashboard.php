              ...
              <div class="info-box content">
                <div class="row">
                  <div class="text-field">
                    ...
                    <select name="User" id="" class="select-box">
        ...
        <div class="box">
          <div class="container info-box-medium left-most">
            <div class="heading-section">
              ...
              <span class="sub-heding-text"
                >school-wide academic statistics</span
              >
            </div>
            <div class="content">
              <div class="info-box-content container">
          ...
          <div class="container info-box-medium right-most">
            <div class="heading-section">
              ...
              <span class="sub-heding-text"
                >Average performance by subject</span
              >
            </div>
            <div class="content">
              <div class="info-box-content container">
            ...
            <div class="content">
              <table class="table">
                <tr class="table-row">
                  ...
                  <th class="table-head">Class Assigned</th>
                  <th class="table-head">Weekly hours</th>
                  <th class="table-head">Status</th>
                </tr>
                <tr class="table-row">
                  <td class="table-data">Kala</td>
                  <td class="table-data">4 classes</td>
                  <td class="table-data">24 hours</td>
                  <td class="table-data">
                    <label for="status" class="label label-green">Normal</label>
                  </td>
                </tr>
                <tr class="table-row">
                  <td class="table-data">Seni</td>
                  <td class="table-data">1 classes</td>
                  <td class="table-data">6 hours</td>
                  <td class="table-data">
                    <label for="status" class="label label-blue">Low</label>
                  </td>
                </tr>
                <tr class="table-row">
                  <td class="table-data">kala</td>
                  <td class="table-data">10 classes</td>
                  <td class="table-data">30 hours</td>
                  <td class="table-data">
                    <label for="status" class="label label-red">High</label>
                  </td>
                </tr>
              </table>
            </div>
        ...
        <div class="box">
          <div class="container info-box-large">
            <div class="heading-section">
              ...
              <span class="sub-heding-text"
                >Review and approve leave requests</span
              >
            </div>
        ...
        <div class="box">
          ...
          <div class="container info-box-medium">
            <div class="heading-section">
              ...
              <span class="sub-heding-text"
                >Real-time system usage statistics</span
              >
            </div>
            <div class="content">
              <div class="row">
              ...
              <div class="row">
                <div class="text-field">
                  ...
                  <select name="group" class="select-box">
                    ...
                    <option value="mp_teachers">
                      Management Panel & Teachers
                    </option>
          ...
          <div class="content">
            <div class="row">
              <div class="data-box">
                ...
                <span class="sub-heading-text">Average Attendence</span>
              </div>
              <div class="data-box">
                <span class="heading heading-blue"> 83.2% </span>
                <span class="sub-heading-text">Acadamic Average </span>
              </div>
              <div class="data-box">
                <span class="heading heading-red"> 15 </span>
                <span class="sub-heading-text">Teacher Vacancies</span>
              </div>
              <div class="data-box">
